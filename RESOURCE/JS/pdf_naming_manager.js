...
/**
 * Módulo para gestión del nombrado automático de PDFs de mantenimiento
 * Permite nombrar PDFs basado en el número de serie con opción de modificación por el usuario
 * 
 * Características principales:
 * - Nombrado automático basado en número de serie
 * - Interfaz modal para edición del nombre
 * - Sanitización automática de caracteres no válidos
 * - Soporte para múltiples tipos de equipos de mantenimiento
 * - Fallback inteligente cuando no hay número de serie
 */
...
class PDFNamingManager {
    ...
    /**
     * Inicializa el módulo creando el modal de nombrado
     */
    init() {
    ...
    sanitizeFilename(nombreArchivo) {
        ...
        const configuracion = {
            caracteresProhibidos: /[<>:"/\\|?*]/g, // Caracteres prohibidos en Windows
            espacios: /\s+/g, // Espacios múltiples
            caracteresPermitidos: /[^\w\-_\.]/g, // Solo letras, números, guiones, guiones bajos y puntos
            longitudMaxima: 100, // Longitud máxima del nombre
            reemplazoEspacio: '_' // Carácter para reemplazar espacios
        };

        // Remover caracteres no válidos para nombres de archivo
        return nombreArchivo
            .replace(configuracion.caracteresProhibidos, '') // Eliminar caracteres prohibidos
            ...
            .substring(0, configuracion.longitudMaxima); // Limitar longitud
    }
    ...
    showNamingModal(numeroSerie, tipoEquipo, alConfirmar) {
        ...
        // Configuración para facilitar edición
